...
export function LoginPage({ onLogin, onBack }: LoginPageProps) {
  ...
  const handleGoogleLogin = () => {
    ...
    onLogin(mockGoogleUser.email, 'google', {
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-8 shadow-2xl backdrop-blur-sm animate-slideInLeft">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-gradient-to-br from-slate-800 to-slate-900 text-slate-400">
                Or continue with
              </span>
            </div>
          </div>
        ...
        <div className="mt-6 p-4 bg-blue-900/20 border border-blue-500/30 rounded-lg text-center">
          <p className="text-blue-300 text-sm">
            <strong>Demo Mode:</strong> Your data is stored locally in your browser. Enter any
            username/email to continue.
          </p>
        </div>
      </div>
    </div>
