...
export function calculateInflation(
  ...
  const totalRosterSpots =
    leagueSettings.numTeams * Object.values(leagueSettings.rosterSpots).reduce((a, b) => a + b, 0);
...
export function adjustPlayerValues(players: Player[], inflationRate: number): Player[] {
