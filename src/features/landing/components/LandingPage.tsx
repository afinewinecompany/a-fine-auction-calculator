 ...
 *
 * Main landing page with the original design featuring:
 * - Dark slate gradient background with animated color orbs
 * - Feature showcase with multi-color accents
 * - How It Works section
 * - CTA section
 *
 * Story: 11.1 - Create Landing Page Component
 * Restored: Original design merged with router navigation
 */
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-6 hover:border-emerald-500/50 transition-all shadow-xl backdrop-blur-sm animate-slideInLeft">
              ...
              <p className="text-slate-400">
                Player values automatically adjust as money leaves the auction pool, ensuring
                accurate valuations throughout your draft.
              </p>
            </div>

            <div
              className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-6 hover:border-blue-500/50 transition-all shadow-xl backdrop-blur-sm animate-slideInLeft"
            ...
            >
              ...
              <p className="text-slate-400">
                Perfectly designed for slow auction drafts where nominations happen at different
                paces. Track bids as they&apos;re called out.
              </p>
            </div>

            <div
              className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-6 hover:border-red-500/50 transition-all shadow-xl backdrop-blur-sm animate-slideInLeft"
            ...
            >
              ...
              <p className="text-slate-400">
                Import projections from Steamer, BatX, or JA via API integration with Couch Manager
                auction rooms.
              </p>
            </div>

            <div
              className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-6 hover:border-purple-500/50 transition-all shadow-xl backdrop-blur-sm animate-slideInLeft"
            ...
            >
              ...
              <p className="text-slate-400">
                Track position needs, budget remaining, and roster construction in real-time during
                your live draft.
              </p>
            </div>

            <div
              className="bg-gradient-to-br from-slate-800 to-slate-900 border border-slate-700 rounded-2xl p-6 hover:border-yellow-500/50 transition-all shadow-xl backdrop-blur-sm animate-slideInLeft"
            ...
            >
              ...
              <p className="text-slate-400">
                Instantly see great deals, fair values, and overpays with intuitive color indicators
            ...
            >
              ...
              <p className="text-slate-400">
                Review your draft performance with comprehensive analytics showing value gained and
                roster strengths.
              </p>
            </div>
          </div>
          ...
          <div className="text-center animate-fadeIn" style={{ animationDelay: '0.6s' }}>
            <Link
              to="/signup"
              className="inline-block px-8 py-4 bg-gradient-to-r from-red-600 via-red-700 to-red-800 text-white text-lg rounded-xl hover:from-red-700 hover:to-red-900 transition-all shadow-2xl shadow-red-500/50 hover:shadow-red-500/70 hover:scale-105 transform"
            >
              ...
              <div className="space-y-4 text-slate-300">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">
                      Set up team count, budget, roster positions, scoring type, and connect your
                      Couch Manager room ID.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">
                      As players are nominated and bid on, enter the bid amount and mark whether
                      it&apos;s your team or another team.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">
                      Player values automatically recalculate based on inflation as the auction
                      progresses.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">
                      After the draft, review your team&apos;s performance and value gained.
                    </p>
                  </div>
                </div>
              </div>
